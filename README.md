# THE Great Giphy  1.2.0
#### made by Mojiboye Emmanuel

#### An application you can input how you feel and then get an amazing gif that completely expresses how you feel. THis is a new update to the existing version 1.1.0
...
* _Note: This is the much anticipaed version 1.2.0, watch out for version 1.3.0 which is still on its way; also in version 1.3.0 I would be making use of one of the latest technologies used for API calls called Async and Await functions_
